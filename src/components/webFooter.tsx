    ...
    >
      <XStack justifyContent="space-between" flexWrap="wrap" mb="$3">
        ...
        <YStack>
          ...
          <Anchor href="/about" color="$color">
            About Us
          </Anchor>
          <Anchor href="/contact" color="$color">
            Contact
          </Anchor>
          <Anchor href="/privacy" color="$color">
            Privacy Policy
          </Anchor>
        </YStack>
        ...
        <YStack>
          ...
          <Anchor href="https://twitter.com" color="$color">
            Twitter
          </Anchor>
          <Anchor href="https://facebook.com" color="$color">
            Facebook
          </Anchor>
          <Anchor href="https://instagram.com" color="$color">
            Instagram
          </Anchor>
        </YStack>
      </XStack>
